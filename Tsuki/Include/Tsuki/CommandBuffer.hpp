...
template <>
struct tk::EnableBitmaskOperators<tk::CommandBufferDirtyFlagBits> : std::true_type {};

template <>
struct std::hash<tk::PipelineCompileInfo> {
	size_t operator()(const tk::PipelineCompileInfo& info) {
